...
public class RedLowScoreAndPark extends SequentialCommandGroup {

    public RedLowScoreAndPark(DrivetrainMecanum drivetrain, Arm arm, Intake intake, Telemetry telemetry) {
