package org.firstinspires.ftc.teamcode.autos.scoreFromStart.red;
...
public class RedHighScore extends SequentialCommandGroup {

    public RedHighScore(DrivetrainMecanum drivetrain, Arm arm, Intake intake, Telemetry telemetry) {
        addCommands(
