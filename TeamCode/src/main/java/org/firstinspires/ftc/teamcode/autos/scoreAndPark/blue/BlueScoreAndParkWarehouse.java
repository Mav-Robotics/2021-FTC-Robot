...
public class BlueScoreAndParkWarehouse extends SequentialCommandGroup {

    public BlueScoreAndParkWarehouse(DrivetrainMecanum drivetrain, Arm arm, Intake intake, Telemetry telemetry) {
        ...
        addCommands(
                ...
                new StrafeDistance(drivetrain, 0.6, 2.0, "LEFT", telemetry).whenFinished(() -> drivetrain.stopAll()),
