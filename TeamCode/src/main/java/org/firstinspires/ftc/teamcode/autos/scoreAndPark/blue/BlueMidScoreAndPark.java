...
public class BlueMidScoreAndPark extends SequentialCommandGroup {

    public BlueMidScoreAndPark(DrivetrainMecanum drivetrain, Arm arm, Intake intake, Telemetry telemetry) {

        addCommands(
                new ArmToPosition(arm, RobotMap.MID_TARGET, telemetry),
                new TurnToAngle(drivetrain, -9.0, 0.5),
                new DriveDistance(drivetrain, 0.6, 16.0, telemetry).whenFinished(() -> drivetrain.stopAll()),
